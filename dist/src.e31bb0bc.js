...
function col(content) {
  var styles = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : '';
  return "<div class=\"col\" style=\"".concat(styles, "\">").concat(content, "</div>");
}
...
var TitleBlock = /*#__PURE__*/function (_Block) {
  ...
  function TitleBlock(value, options) {
    ...
    return _super.call(this, value, options); //Isvkieciame inicializacija, kad atsirastu viso klases Block savybes. Title fiksuotas, todel ji neperduodame i kontruktori
  }
  ...
  _createClass(TitleBlock, [{
    ...
    value: function toHTML() {
      var _this$options = this.options,
          ...
          styles = _this$options.styles; //Todel kad dukterinis komponentas block, rasome this
...
var ColumnsBlock = /*#__PURE__*/function (_Block3) {
  ...
  _createClass(ColumnsBlock, [{
    ...
    value: function toHTML() {
      ...
      return (0, _utils.row)(html.join(''), (0, _utils.css)(this.options.styles));
    }
  }]);
...
exports.App = App;
},{"./site":"classes/site.js","./sidebar":"classes/sidebar.js","../styles/main.css":"styles/main.css"}],"assets/image.png":[function(require,module,exports) {
...
var text = 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Placeat sit dolorem consequuntur eos ipsum sequi?';
var model = [new _blocks.TitleBlock('Constructor site on Vanila JS!', {
  tag: 'h2',
  styles: {
...
}), new _blocks.ColumnsBlock(['Labas  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eos nisi nobis quae ad suscipit porro.', 'Lorem ipsum dolor sit amet consectetur adipisicing elit. Animi a dolorem omnis voluptatem molestiae quidem.', 'Lorem ipsum dolor sit amet consectetur, adipisicing elit. Distinctio consequatur molestias quisquam? Ducimus, laudantium sed?'], {
  styles: {
...
exports.model = model;
},{"./assets/image.png":"assets/image.png","./classes/blocks":"classes/blocks.js"}],"index.js":[function(require,module,exports) {
"use strict";
...
},{"./classes/app":"classes/app.js","./model":"model.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
